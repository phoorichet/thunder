...
class RidersControllerTest < ActionController::TestCase
  ...
  test "should create rider" do
    assert_difference('Rider.count') do
      post :create, rider: { code_name: @rider.code_name, description: @rider.description, name: @rider.name, status: @rider.status }
    end
  ...
  test "should update rider" do
    patch :update, id: @rider, rider: { code_name: @rider.code_name, description: @rider.description, name: @rider.name, status: @rider.status }
    assert_redirected_to rider_path(assigns(:rider))
  end
