class CoveragesController < ApplicationController
  ...
  private
    ...
    def coverage_params
      params.require(:coverage).permit(:name, :description, :coverage_amount, :category, :rider_id, :rider_id, :abbr, :premium_amount, :premium_unit, :coverage_unit, :coverage_end_at)
    end
